...
class PlantRepository private constructor(
    ...
    val plants = liveData<List<Plant>> {
        ...
        val customerSortOrder = plantsListSortOrderCache.getOrAwait()

        emitSource(plantsLiveData.map { plantList ->
            plantList.applySort(customerSortOrder)
        })
    }
    ...
    val plantsFlow: Flow<List<Plant>>
        get() = plantDao.getPlantsFlow()
            ...
            .conflate() // перезаписывает значение в буффере последним пришедшим значением
